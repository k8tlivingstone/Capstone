...
//	public static String ctz = null;
	...
	public NamePg() {
		...
		MenuPage.fName = tfFName.getText();
		MenuPage.lName = tfLName.getText();
		MenuPage.oRg = tfOrganization.getText();
	 ...
	 * @return the tfFname
	 */
	public static String gettfFName() {
		return fn;
	}
	 ...
	 * @return the tfLName
	 */
	public static String gettfLName() {
		return ln;
	}
	 ...
	 */
	public static String getTfOrganization() {
		return o;
	}
	...
	public void setTfOrganization(JTextField tfOrganization) {
		if (MenuPage.oRg.isEmpty()) {
			o = "NA";
		} else { 
			o = tfOrganization.getText();
		}
	...
	public void setCitizen() {
		if (rCitizen_Yes.isSelected()) {
			citizen = "Yes";
		} else if (rCitizen_No.isSelected()) {
			citizen = "No";
		} else {
			citizen = null;
			JOptionPane.showMessageDialog(null, "Select your citizenship status");
		}
