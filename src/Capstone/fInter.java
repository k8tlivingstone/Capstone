...
public class fInter extends JFrame {
	...
	public static String Purpose = "interview";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					fInter fInter = new fInter();
					fInter.setExtendedState(fInter.getExtendedState() | JFrame.MAXIMIZED_BOTH);
