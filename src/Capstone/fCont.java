...
public class fCont extends JFrame {
	...
	CardLayout clCont = new CardLayout();
	...
	public static String Purpose = "contractor";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					fCont fCont = new fCont();
					fCont.setExtendedState(fCont.getExtendedState() | JFrame.MAXIMIZED_BOTH);
					fCont.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
