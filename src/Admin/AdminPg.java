...
import CapstoneProject.CapstoneProject;
		...
		btnOnSite.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (result == JFileChooser.APPROVE_OPTION) {
					...
					try {
						List<CurrentOnSite> listCurrentOnSite = eh.readData(CurrentOnSite.class.getName());
						DefaultTableModel dtm = new DefaultTableModel();
						dtm.addColumn("Id");
						dtm.addColumn("Purpose");
						...
						for (CurrentOnSite os : listCurrentOnSite) {
							dtm.addRow(new Object[] { os.getRecordId(), os.getPurpose(), os.getFname(), os.getLname(),
									os.getStatus(), os.getContact(), os.getDt_In(), os.getDt_Out() });
						}
						CurrentOnSiteReport.getTableCurrent().setModel(dtm);
					} catch (Exception e1) {
